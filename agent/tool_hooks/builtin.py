...
class ToolRiskGuardHook(ToolHook):
    ...
    def __init__(
        ...
        *,
        ...
        message_prefix: str = "tool call denied by risk policy",
    ) -> None:
        self._allowed_risks = set(
            allowed_risks or {"read-only", "write", "external-side-effect"}
        )
        self._message_prefix = message_prefix

    def matches(self, ctx: HookContext) -> bool:
        return bool(ctx.request.tool_name)
