...
from agent.tools.checkpoint import RestoreCheckpointTool
...
def register_memory_meta_tools(
    ...
    restore_checkpoint_tool: RestoreCheckpointTool | None = None,
) -> None:
    ...
    if restore_checkpoint_tool is not None:
        tools.register(
            restore_checkpoint_tool,
            always_on=True,
            risk="write",
            search_hint="undo rollback checkpoint restore revert file edit",
        )
