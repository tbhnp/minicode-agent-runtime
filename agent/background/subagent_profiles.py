...
def build_scripting_spec(
    *,
    ...
    checkpoint_store = FileCheckpointStore(task_dir)
    tools: list[Tool] = [
        ReadFileTool(allowed_dir=workspace),
        ListDirTool(allowed_dir=workspace),
        WriteFileTool(allowed_dir=task_dir, checkpoint_store=checkpoint_store),
        EditFileTool(allowed_dir=task_dir, checkpoint_store=checkpoint_store),
        RestoreCheckpointTool(allowed_dir=task_dir, checkpoint_store=checkpoint_store),
        ShellTool(
            allow_network=False,
